                ...
                <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16 max-w-6xl mx-auto">
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left order-1 lg:order-2">
                        ...
                        <p className="text-gray-600 text-base sm:text-lg lg:text-xl leading-relaxed mb-8 sm:mb-12 max-w-2xl mx-auto lg:mx-0">
                           From appointments to digital records, everything your furry friend needs will be soon be just a tap away. 
                        </p>
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            <div className="relative inline-block">
                                <div className="absolute inset-0 bg-gradient-to-r from-[#3F3D56]/10 via-[#FE5F62]/10 to-blue-500/10 blur-xl rounded-2xl"></div>
                                <div className="relative bg-gradient-to-r from-[#3F3D56] via-[#3F3D56] to-[#FE5F62] p-[2px] rounded-2xl">
                                    <div className="bg-white px-6 py-4 rounded-2xl">
                                        <p className="text-transparent bg-clip-text bg-gradient-to-r from-[#3F3D56] via-blue-600 to-[#FE5F62] text-lg sm:text-xl lg:text-2xl font-bold animate-pulse">
                                            🎉 Sniffi App is Coming Soon on iOS & Android! 🐾
                                        </p>
                                    </div>
                                </div>
                            </div>
