                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 border-t border-white/20 pt-10">
                    ...
                    <div className="text-base font-normal leading-relaxed">
                        ...
                        <p className="text-gray-300">
                            At Sniffi, we are dedicated to providing top-notch veterinary care
                            with love and compassion. From routine check-ups to emergency
                            treatments, we ensure your furry companions get the best care
                            possible.
                        </p>
                        ...
                        <div className="mt-6">
                            <p className="flex items-center gap-2 text-gray-300 mb-2">
                                <svg
                                    ...
                                    className="h-10 w-10 text-[#FE5F62]"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                                ...
                                Address : Office no. 320, 10 Biz Park, Viman Nagar, Pune 411014
                            </p>

                            <p className="flex items-center gap-2 text-gray-300">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 text-[#FE5F62]"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mb-6">
                            <a
                                href="#"
                                aria-label="Facebook"
                                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#FE5F62] transition-colors duration-300"
                            >
                                <svg
                                    className="w-5 h-5"
                                    fill="currentColor"
                        ...
                        <div className="text-sm text-gray-300">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                                <a
                                    href="#"
                                    className="bg-white/10 hover:bg-white/20 px-4 py-2 rounded flex items-center gap-2 transition-colors duration-300"
                                >
                                    <svg
                                        className="w-5 h-5"
                                        viewBox="0 0 24 24"
                ...
                <div className="border-t border-white/20 mt-10 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-gray-300">
                            ...
                            <Link
                                to="/tandc"
                                className="hover:text-[#FE5F62] transition-colors duration-300"
                            >
                                Terms & Conditions
                            </Link>
